export const validarOrdenSalida = (req, res, next) => {
  const { cliente_id, fecha, productos, usuario_id } = req.body;

  // Validar campos requeridos
  const camposRequeridos = ['cliente_id', 'fecha', 'productos', 'usuario_id'];
